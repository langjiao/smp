...
import com.xuaiyuan.smp.modules.sys.entity.SysDeptEntity;
import com.xuaiyuan.smp.modules.sys.service.SysDeptService;
...
public class SysDeptController extends AbstractController {
	...
	public Result select(){
		...
		return Result.success().put("deptList", deptList);
	}
	...
	public Result info(){
		...
		return Result.success().put("deptId", deptId);
	}
	...
	public Result info(@PathVariable("deptId") Long deptId){
		...
		return Result.success().put("dept", dept);
	}
